...
#define RTSP_DISABLE_TCP_TRANSPORT 1 /* To debug UDP transport, set to 1 */
 ...
 * @param session RTSP session
 * @return 0 if cleanup completed immediately, 1 if async TEARDOWN initiated (cleanup deferred)
 */
